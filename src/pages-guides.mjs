...
export const PORADNIKI = [
  {
    ...
    kroki: [
      ...
      { t: 'Wanna albo kabina', w: 'montaz_wanny', txt: 'Wanna akrylowa idzie na stelaż z obudową i rewizją do syfonu, kabina z brodzikiem albo bez. Wersja bez brodzika wymaga spadków wyrobionych wcześniej i lepiej wygląda, ale przy nieszczelnej izolacji mści się natychmiast.' },
