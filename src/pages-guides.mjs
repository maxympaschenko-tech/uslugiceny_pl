...
export const PORADNIKI = [
  ...
  },
  {
    ...
    kroki: [
      ...
      { t: 'Okna dachowe i kominki wentylacyjne', w: 'kominek_wentylacyjny', txt: 'Osadzenie okien z kołnierzem dobranym do rodzaju pokrycia oraz kominki wentylacyjne w liczbie wynikającej z powierzchni połaci.' },
