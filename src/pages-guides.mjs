...
export const PORADNIKI = [
  {
    ...
    kroki: [
      ...
      { t: 'Baterie i podłączenie pralki', w: 'montaz_baterii', txt: 'Baterie podtynkowe wymagają osadzenia korpusu w ścianie przed płytkowaniem, natynkowe montuje się na końcu. Pralka potrzebuje zaworu kątowego i syfonu z króćcem: bez króćca wąż wkłada się luzem do odpływu, co przy pierwszym zapchaniu kończy się zalaniem.' },
  ...
  },
  {
    ...
    kroki: [
      ...
      { t: 'Wyburzenia i wywóz', w: 'wyburzenie_scianki', txt: 'Rozbiórka ścianek działowych, zrywanie starych tapet i wywóz gruzu w kontenerze. Przed rozbiórką sprawdza się, czy w ściance nie biegną instalacje i czy na pewno nie jest nośna. Gruz czysty jest tańszy w utylizacji niż zmieszany, więc segregacja opłaca się już na budowie.' },
      ...
      { t: 'Zabudowy i sufity podwieszane', w: 'gk_sufit', txt: 'Obudowa pionów, zabudowa ścian płytą oraz sufit podwieszany pod oświetlenie punktowe. Sufit obniża pomieszczenie o kilkanaście centymetrów, więc przy niskich stropach warto policzyć, czy warto. Wycięcia pod oprawy planuje się razem z elektrykiem.' },
  ...
  },
  {
    ...
    kroki: [
      ...
      { t: 'Dach płaski albo o małym spadku', w: 'papa_termozgrzewalna', txt: 'Na połaciach o niewielkim nachyleniu pokrycia układane z zakładem nie zadziałają: woda podchodzi pod spód. Stosuje się wtedy papę termozgrzewalną w dwóch warstwach albo rąbek stojący, a na łukach i wieżyczkach gont bitumiczny na pełnym deskowaniu.' },
