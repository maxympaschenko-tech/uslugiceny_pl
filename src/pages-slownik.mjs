...
export const HASLA = [
  ...
  ['Kapinos', 'kapinos', 'Wyprofilowana krawędź obróbki blacharskiej, która odrywa spływającą wodę od lica płyty balkonowej. Bez niego woda spływa po elewacji i po kilku sezonach zostawia trwałe zacieki pod balkonem.', 'obrobki_balkonu'],
  ['Płytka mrozoodporna', 'plytka-mrozoodporna', 'Gres o nasiąkliwości poniżej trzech procent, który nie chłonie wody i nie pęka przy zamarzaniu. Na balkon dobiera się dodatkowo klasę antypoślizgową, bo mokra powierzchnia na zewnątrz bywa niebezpieczna.', 'plytki_mrozoodporne'],
  ['Próba wodna', 'proba-wodna', 'Zalanie powierzchni po wykonaniu hydroizolacji i sprawdzenie szczelności przed ułożeniem okładziny. Etap wykonywany rzadko, a jako jedyny daje pewność, że izolacja działa, zanim zakryją ją płytki.', 'hydroizolacja_balkonu'],
  ...
  ['Legary tarasowe', 'legary', 'Belki, na których leży deska tarasowa. Rozstaw dobiera się do grubości deski: przy kompozycie 30 do 40 centymetrów w osi, przy drewnie gęściej. Oszczędność na podkonstrukcji kończy się ugięciem najdroższej nawet deski.', 'konstrukcja_tarasu'],
